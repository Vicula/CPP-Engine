...
struct ProjectileEmitterComponent
{
    ...
    ProjectileEmitterComponent(glm::vec2 projectileVelocity = glm::vec2(0), int repeatFrequency = 0, int projectileDuration = 1000, int hitPercentDamage = 10, bool isFriendly = false)
    {
