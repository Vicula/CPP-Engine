...
InputHandler::InputHandler() : mousePosition(new glm::vec2(0, 0))
// keystates(0)
{
    // reset all states
    for (int i = 0; i < 3; i++)
...
void InputHandler::ProcessInput(GLFWwindow *window, std::unique_ptr<EventHandler> &eventHandler, bool *isRunning, bool *isDebug)
{
